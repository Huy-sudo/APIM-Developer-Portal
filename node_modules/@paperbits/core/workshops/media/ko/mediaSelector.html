    ...
    <div class="list flex flex-column">
        <div class="flex flex-row flex-wrap flex-item flex-item-grow" role="listbox" data-bind="scrollable: true, listbox: {}">
            ...
            <a role="option" class="list-item list-item-image"
                data-bind="activate: $component.selectMedia, css: { selected: $component.isSelected(media) }, attr: { 'aria-label': media.fileName() }, balloon: { activateOn: 'hoverOrFocus', isDisabled: nonPreviewable, delay: 800, position: 'right', component: { name: 'media-display', params: { item: media }}}">
                <span aria-hidden="true" class="thumbnail"
            ...
            <div aria-hidden="true" class="list-edge" data-bind="whenInView: $component.loadNextPage"></div>
            <!-- /ko -->
        </div>

        <div class="flex-item btn-group">
            <button class="btn btn-default" data-bind="activate: $component.uploadMedia">
                <i aria-hidden="true" class="paperbits-icon paperbits-square-upload"></i>
                Upload file
            </button>
            <button class="btn btn-default" data-bind="activate: $component.selectNone">
